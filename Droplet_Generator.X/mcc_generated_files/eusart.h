/**
  EUSART Driver API Header File

  File Name:
    eusart.h

  Summary:
    This is the header file for the EUSART driver using PIC18F25k40
...
/**
  @Summary
    Writes a string of characters to the EUSART.

  @Description
    This routine writes a string of characters to the EUSART.
  ...
  @Param
    data  - Data character array to write to the EUSART
